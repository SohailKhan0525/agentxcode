<p align="center">
  <a href="https://agentx.js.org">
    <picture>
      ...
      <img src="agentx-logo.svg" alt="Logo do AgentX Code">
    </picture>
  </a>
</p>
...
brew install SohailKhan0525/agentx/agentx # macOS e Linux (recomendado, sempre atualizado)
...
nix run nixpkgs#opencode           # ou github:SohailKhan0525/agentxcode para a branch dev mais recente
```
...
O AgentX Code também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/SohailKhan0525/agentxcode/releases) ou em [opencode.ai/download](https://agentx.js.org/download).
...
Saiba mais sobre [agents](https://agentx.js.org/docs/agents).

### Documentação

Para mais informações sobre como configurar o AgentX Code, [**veja nossa documentação**](https://agentx.js.org/docs).
...
Se você estiver trabalhando em um projeto relacionado ao AgentX Code e estiver usando "opencode" como parte do nome (por exemplo, "opencode-dashboard" ou "opencode-mobile"), adicione uma nota no README para deixar claro que não foi construído pela equipe do AgentX Code e não é afiliado a nós de nenhuma forma.
