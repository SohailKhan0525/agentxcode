...
# 패키지 매니저
npm i -g @agent-qofeno/agentx-cli@latest        # bun/pnpm/yarn 도 가능
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS 및 Linux (권장, 항상 최신)
brew install opencode              # macOS 및 Linux (공식 brew formula, 업데이트 빈도 낮음)
sudo pacman -S opencode            # Arch Linux (Stable)
paru -S opencode-bin               # Arch Linux (Latest from AUR)
mise use -g opencode               # 어떤 OS든
nix run nixpkgs#opencode           # 또는 github:SohailKhan0525/agentxcode 로 최신 dev 브랜치
```
...
AgentX Code 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/SohailKhan0525/agentxcode/releases) 에서 직접 다운로드하거나 [opencode.ai/download](https://agentx.js.org/download) 를 이용하세요.
...
AgentX Code 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://agentx.js.org/docs/agents) 에 대해 더 알아보세요.

### 문서

AgentX Code 설정에 대한 자세한 내용은 [**문서**](https://agentx.js.org/docs) 를 참고하세요.

### 기여하기

AgentX Code 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### AgentX Code 기반으로 만들기

AgentX Code 와 관련된 프로젝트를 진행하면서 이름에 "opencode"(예: "opencode-dashboard" 또는 "opencode-mobile") 를 포함한다면, README 에 해당 프로젝트가 AgentX Code 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.
