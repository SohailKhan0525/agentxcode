...
# Pakkehåndterere
npm i -g @agent-qofeno/agentx-cli@latest        # eller bun/pnpm/yarn
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS og Linux (anbefalt, alltid oppdatert)
...
nix run nixpkgs#opencode           # eller github:SohailKhan0525/agentxcode for nyeste dev-branch
```
...
AgentX Code er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/SohailKhan0525/agentxcode/releases) eller [opencode.ai/download](https://agentx.js.org/download).
...
AgentX Code har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://agentx.js.org/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer AgentX Code, [**se dokumentasjonen**](https://agentx.js.org/docs).

### Bidra

Hvis du vil bidra til AgentX Code, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på AgentX Code

Hvis du jobber med et prosjekt som er relatert til AgentX Code og bruker "opencode" som en del av navnet; for eksempel "opencode-dashboard" eller "opencode-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av AgentX Code-teamet og ikke er tilknyttet oss på noen måte.
