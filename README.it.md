...
# Package manager
npm i -g @agent-qofeno/agentx-cli@latest        # oppure bun/pnpm/yarn
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS e Linux (consigliato, sempre aggiornato)
...
nix run nixpkgs#opencode           # oppure github:SohailKhan0525/agentxcode per l’ultima branch di sviluppo
```
...
AgentX Code è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/SohailKhan0525/agentxcode/releases) oppure da [opencode.ai/download](https://agentx.js.org/download).
...
Scopri di più sugli [agenti](https://agentx.js.org/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare AgentX Code, [**consulta la nostra documentazione**](https://agentx.js.org/docs).
...
Se stai lavorando a un progetto correlato a AgentX Code e che utilizza “opencode” come parte del nome (ad esempio “opencode-dashboard” o “opencode-mobile”), aggiungi una nota nel tuo README per chiarire che non è sviluppato dal team AgentX Code e che non è affiliato in alcun modo con noi.
