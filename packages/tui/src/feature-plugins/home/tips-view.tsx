...
const TIPS: Tip[] = [
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.agentxcode/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.agentxcode/plugins/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent AgentX Code from reading sensitive files",
  "Use {highlight}agentx run{/highlight} for non-interactive scripting",
  "Use {highlight}agentx --continue{/highlight} to resume the last session",
  "Use {highlight}agentx run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}agentx serve{/highlight} for headless API access to AgentX Code",
  "Use {highlight}agentx run --attach{/highlight} to connect to a running server",
  "Run {highlight}agentx upgrade{/highlight} to update to the latest version",
  "Run {highlight}agentx auth list{/highlight} to see all configured providers",
  "Run {highlight}agentx agent create{/highlight} for guided agent creation",
  ...
  "Create JSON theme files in {highlight}.agentxcode/themes/{/highlight} directory",
  ...
  "Run {highlight}agentx debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/sohailkhan0525/agentx{/highlight} in a container",
  "Use {highlight}/connect{/highlight} to configure local and cloud model providers",
