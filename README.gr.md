...
npm i -g @agent-qofeno/agentx-cli@latest        # ή bun/pnpm/yarn
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS και Linux (προτείνεται, πάντα ενημερωμένο)
...
nix run nixpkgs#opencode           # ή github:SohailKhan0525/agentxcode με βάση την πιο πρόσφατη αλλαγή από το dev branch
```
...
Το AgentX Code είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/SohailKhan0525/agentxcode/releases) ή το [opencode.ai/download](https://agentx.js.org/download).
...
Το AgentX Code περιλαμβάνει δύο ενσωματωμένους πράκτορες μεταξύ των οποίων μπορείτε να εναλλάσσεστε με το πλήκτρο `Tab`.
...
Μάθετε περισσότερα για τους [πράκτορες](https://agentx.js.org/docs/agents).

### Οδηγός Χρήσης

Για περισσότερες πληροφορίες σχετικά με τη ρύθμιση του AgentX Code, [**πλοηγήσου στον οδηγό χρήσης μας**](https://agentx.js.org/docs).

### Συνεισφορά

Εάν ενδιαφέρεσαι να συνεισφέρεις στο AgentX Code, διαβάστε τα [οδηγό χρήσης συνεισφοράς](./CONTRIBUTING.md) πριν υποβάλεις ένα pull request.

### Δημιουργία πάνω στο AgentX Code

Εάν εργάζεσαι σε ένα έργο σχετικό με το AgentX Code και χρησιμοποιείτε το "opencode" ως μέρος του ονόματός του, για παράδειγμα "opencode-dashboard" ή "opencode-mobile", πρόσθεσε μια σημείωση στο README σας για να διευκρινίσεις ότι δεν είναι κατασκευασμένο από την ομάδα του AgentX Code και δεν έχει καμία σχέση με εμάς.
