...
# Менеджери пакетів
npm i -g @agent-qofeno/agentx-cli@latest        # або bun/pnpm/yarn
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS і Linux (рекомендовано, завжди актуально)
...
nix run nixpkgs#opencode           # або github:SohailKhan0525/agentxcode для найновішої dev-гілки
```
...
AgentX Code також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/SohailKhan0525/agentxcode/releases) або [opencode.ai/download](https://agentx.js.org/download).
...
Дізнайтеся більше про [agents](https://agentx.js.org/docs/agents).

### Документація

Щоб дізнатися більше про налаштування AgentX Code, [**перейдіть до нашої документації**](https://agentx.js.org/docs).
...
Якщо ви працюєте над проєктом, пов'язаним з AgentX Code, і використовуєте "opencode" у назві, наприклад "opencode-dashboard" або "opencode-mobile", додайте примітку до свого README.
