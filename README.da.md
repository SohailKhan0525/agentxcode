...
brew install SohailKhan0525/agentx/agentx # macOS og Linux (anbefalet, altid up to date)
...
AgentX Code findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/SohailKhan0525/agentxcode/releases) eller [opencode.ai/download](https://agentx.js.org/download).
...
Læs mere om [agents](https://agentx.js.org/docs/agents).

### Dokumentation

For mere info om konfiguration af AgentX Code, [**se vores docs**](https://agentx.js.org/docs).
...
Hvis du arbejder på et projekt der er relateret til AgentX Code og bruger "opencode" som en del af navnet; f.eks. "opencode-dashboard" eller "opencode-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af AgentX Code-teamet og ikke er tilknyttet os på nogen måde.
