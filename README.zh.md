...
brew install SohailKhan0525/agentx/agentx # macOS 和 Linux（推荐，始终保持最新）
brew install opencode              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S opencode            # Arch Linux (Stable)
paru -S opencode-bin               # Arch Linux (Latest from AUR)
mise use -g opencode               # 任意系统
nix run nixpkgs#opencode           # 或用 github:SohailKhan0525/agentxcode 获取最新 dev 分支
```
...
AgentX Code 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/SohailKhan0525/agentxcode/releases) 或 [opencode.ai/download](https://agentx.js.org/download) 下载。
...
AgentX Code 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://agentx.js.org/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://agentx.js.org/docs)。
...
如果你在项目名中使用了 “opencode”（如 “opencode-dashboard” 或 “opencode-mobile”），请在 README 里注明该项目不是 AgentX Code 团队官方开发，且不存在隶属关系。
