...
# Menedżery pakietów
npm i -g @agent-qofeno/agentx-cli@latest        # albo bun/pnpm/yarn
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS i Linux (polecane, zawsze aktualne)
...
nix run nixpkgs#opencode           # lub github:SohailKhan0525/agentxcode dla najnowszej gałęzi dev
```
...
AgentX Code jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/SohailKhan0525/agentxcode/releases) lub z [opencode.ai/download](https://agentx.js.org/download).
...
AgentX Code zawiera dwóch wbudowanych agentów, między którymi możesz przełączać się klawiszem `Tab`.
...
Dowiedz się więcej o [agents](https://agentx.js.org/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji AgentX Code znajdziesz w [**dokumentacji**](https://agentx.js.org/docs).

### Współtworzenie

Jeśli chcesz współtworzyć AgentX Code, przeczytaj [contributing docs](./CONTRIBUTING.md) przed wysłaniem pull requesta.

### Budowanie na AgentX Code

Jeśli pracujesz nad projektem związanym z AgentX Code i używasz "opencode" jako części nazwy (na przykład "opencode-dashboard" lub "opencode-mobile"), dodaj proszę notatkę do swojego README, aby wyjaśnić, że projekt nie jest tworzony przez zespół AgentX Code i nie jest z nami w żaden sposób powiązany.
