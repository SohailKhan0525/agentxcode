...
npm i -g @agent-qofeno/agentx-cli@latest        # o bun/pnpm/yarn
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS y Linux (recomendado, siempre al día)
...
nix run nixpkgs#opencode           # o github:SohailKhan0525/agentxcode para la rama dev más reciente
```
...
AgentX Code también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/SohailKhan0525/agentxcode/releases) o desde [opencode.ai/download](https://agentx.js.org/download).
...
AgentX Code incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://agentx.js.org/docs/agents).

### Documentación

Para más información sobre cómo configurar AgentX Code, [**ve a nuestra documentación**](https://agentx.js.org/docs).

### Contribuir

Si te interesa contribuir a AgentX Code, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en AgentX Code

Si estás trabajando en un proyecto basado en AgentX Code y usas "opencode" como parte del nombre, por ejemplo, "opencode-dashboard" u "opencode-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de AgentX Code y que no está afiliado con nosotros de ninguna manera.
