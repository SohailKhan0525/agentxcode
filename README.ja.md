...
# パッケージマネージャー
npm i -g @agent-qofeno/agentx-cli@latest        # bun/pnpm/yarn でもOK
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS と Linux（推奨。常に最新）
brew install opencode              # macOS と Linux（公式 brew formula。更新頻度は低め）
sudo pacman -S opencode            # Arch Linux (Stable)
paru -S opencode-bin               # Arch Linux (Latest from AUR)
mise use -g opencode               # どのOSでも
nix run nixpkgs#opencode           # または github:SohailKhan0525/agentxcode で最新 dev ブランチ
```
...
AgentX Code はデスクトップアプリとしても利用できます。[releases page](https://github.com/SohailKhan0525/agentxcode/releases) から直接ダウンロードするか、[opencode.ai/download](https://agentx.js.org/download) を利用してください。
...
[agents](https://agentx.js.org/docs/agents) の詳細はこちら。

### ドキュメント

AgentX Code の設定については [**ドキュメント**](https://agentx.js.org/docs) を参照してください。
...
AgentX Code に関連するプロジェクトで、名前に "opencode"（例: "opencode-dashboard" や "opencode-mobile"）を含める場合は、そのプロジェクトが AgentX Code チームによって作られたものではなく、いかなる形でも関係がないことを README に明記してください。
