...
# Менеджеры пакетов
npm i -g @agent-qofeno/agentx-cli@latest        # или bun/pnpm/yarn
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS и Linux (рекомендуем, всегда актуально)
...
nix run nixpkgs#opencode           # или github:SohailKhan0525/agentxcode для самой свежей ветки dev
```
...
AgentX Code также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/SohailKhan0525/agentxcode/releases) или с [opencode.ai/download](https://agentx.js.org/download).
...
Подробнее об [agents](https://agentx.js.org/docs/agents).

### Документация

Больше информации о том, как настроить AgentX Code: [**наши docs**](https://agentx.js.org/docs).
...
Если вы делаете проект, связанный с AgentX Code, и используете "opencode" как часть имени (например, "opencode-dashboard" или "opencode-mobile"), добавьте примечание в README, чтобы уточнить, что проект не создан командой AgentX Code и не аффилирован с нами.
