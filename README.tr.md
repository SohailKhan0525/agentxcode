...
# Paket yöneticileri
npm i -g @agent-qofeno/agentx-cli@latest        # veya bun/pnpm/yarn
scoop install opencode             # Windows
choco install opencode             # Windows
brew install SohailKhan0525/agentx/agentx # macOS ve Linux (önerilir, her zaman güncel)
...
nix run nixpkgs#opencode           # veya en güncel geliştirme dalı için github:SohailKhan0525/agentxcode
```
...
AgentX Code ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/SohailKhan0525/agentxcode/releases) veya [opencode.ai/download](https://agentx.js.org/download) adresinden indirebilirsiniz.
...
[Ajanlar](https://agentx.js.org/docs/agents) hakkında daha fazla bilgi edinin.

### Dokümantasyon

AgentX Code'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://agentx.js.org/docs).
